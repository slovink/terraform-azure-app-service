...
locals {
  ...
  # app insights
  app_insights = try(data.azurerm_application_insights.main[*], try(azurerm_application_insights.main[*], {}))
...
resource "azurerm_application_insights" "main" {
  ...
  disable_ip_masking  = upper(var.disable_ip_masking)
  tags                = merge({ "ResourceName" = upper(var.app_insights_name) }, module.labels.tags, )
}
